...
import com.subranil.pagination.db.RemoteKeys
...
const val QUERY = "androidin:name,description"
...
class GithubRemoteMediator(
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Repo>): MediatorResult {
        ...
        try {
            val apiResponse = service.searchRepositories(QUERY, page, state.config.pageSize)
            val repos = apiResponse.items
            val endOfPage = repos.isEmpty()
            repoDatabase.withTransaction {
                ...
                val keys =
                    repos.map { RemoteKeys(repoId = it.id, prevKey = prevKey, nextKey = nextKey) }
